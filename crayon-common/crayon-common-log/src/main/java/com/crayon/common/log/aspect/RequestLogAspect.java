package com.crayon.common.log.aspect;

import com.alibaba.fastjson.JSON;
import com.crayon.common.core.RequestInfo;
import com.crayon.common.core.id.CrayonIdWorker;
...
public class RequestLogAspect {
    ...
    public Object doAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        requestInfo.setTraceId(CrayonIdWorker.generateId());
    ...
    public void doAfterThrow(JoinPoint joinPoint, RuntimeException e) {
        ...
        requestErrorInfo.setRequestUrl(request.getRequestURL().toString());
